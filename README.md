...
## File structure
- 'mu_and_Jet_check': Exploratory notebook used to inspect the ROOT file structure, validate branches, and produce basic kinematic sanity plots (pT, η, φ) for muons and jets.
